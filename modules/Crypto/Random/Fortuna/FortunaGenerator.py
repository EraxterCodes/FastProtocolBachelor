...
if sys.version_info[0] is 2 and  sys.version_info[1] is 1:
    from modules.Crypto.Util.py21compat import *
from modules.Crypto.Util.py3compat import *

import struct

from modules.Crypto.Util.number import ceil_shift, exact_log2, exact_div
from modules.Crypto.Util import Counter
from modules.Crypto.Cipher import AES
